...
\section{Ausbildung}
\periodentry{10/2015 -- 08/2018}{Ruprecht-Karls-Universität Heidelberg}
\studyentry{Master of Science Economics}{1.8}{The Labor Train in Vain: Quasi-Experimental Evidence on Eco-}{nomic Shocks and Migration}{Prof. Dr. Axel Dreher}
...
\profitem{Aufbereitung und Analsye von Datensätzen, Literaturrecherche}
...
\skillentry{MS Office}{Stata}{LaTeX}{Sehr gut}{R}{Grundkenntnisse}
\skill{Sprachkenntnisse}
\langentry{Englisch}{Sehr gut}{Portugiesisch}{Gut}{Spanisch}{Grundkenntnisse}{Latinum}{}

\section{Sonstiges}
\periodentrywob{05/2008 -- 10/2017}{Tennisschule Prätorius \& Pählich}
\profitem{Tennistrainer beim TC Wehen und TV Grün-Weiss Weinheim}
\yearentry{2015}{Ausbildung zum C-Trainer beim Badischen Tennis-Verband}


\signature{Unterschrift.jpg}
\append{Notenauszug Master, Bachelor- \& Abiturzeugnis, Nachweise für Praktika, Zivildienst und Fremdsprachen}
